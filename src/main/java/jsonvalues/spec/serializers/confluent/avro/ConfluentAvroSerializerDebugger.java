 ...
 */
public final class ConfluentAvroSerializerDebugger implements Consumer<RecordedEvent> {

  /**
   * The singleton instance of {@code SpecSerializerDebugger}.
   */
  public static final ConfluentAvroSerializerDebugger INSTANCE = new ConfluentAvroSerializerDebugger();
