...
public final class SpecToAvroSchema {
   ...
   * {@link JsArrayOfSpec}, the conversion is performed by the specialized method {@link #convert(JsArraySpec)}. Generic
   * {@link JsSpec} instances are converted using the Avro {@link Schema.Parser} after converting them to a JSON
   * representation.
   * </p>
   *
