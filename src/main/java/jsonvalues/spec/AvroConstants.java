...
final class AvroConstants {
  ...
  static final JsArray NULL_STR_TYPE = JsArray.of("null",
                                                  "string");
  static final JsArray STR_NULL_TYPE = JsArray.of("string",
                                                  "null");
  static final JsStr STR_TYPE = JsStr.of("string");
  static final JsArray NULL_BOOL_TYPE = JsArray.of("null",
                                                   "boolean");
  static final JsArray BOOL_NULL_TYPE = JsArray.of("boolean",
                                                   "null");
  static final JsStr BOOL_TYPE = JsStr.of("boolean");
  static final JsArray NULL_LONG_TYPE = JsArray.of("null",
                                                   "long");
  static final JsArray LONG_NULL_TYPE = JsArray.of("long",
                                                   "null");
  static final JsArray NULL_INT_TYPE = JsArray.of("null",
                                                  "int");
  static final JsArray INT_NULL_TYPE = JsArray.of("int",
                                                  "null");
  static final JsStr INT_TYPE = JsStr.of("int");
  static final JsArray NULL_DOUBLE_TYPE = JsArray.of("null",
                                                     "double");
  static final JsArray DOUBLE_NULL_TYPE = JsArray.of("double",
                                                     "null");
  static final JsStr DOUBLE_TYPE = JsStr.of("double");
  static final JsArray NULL_BINARY_TYPE = JsArray.of("null",
                                                     "bytes");
  static final JsArray BINARY_NULL_TYPE = JsArray.of("bytes",
                                                     "null");
