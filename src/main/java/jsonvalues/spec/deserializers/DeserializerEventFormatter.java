...
/**
 * A function that takes the Java Flight Recorder (JFR) events generated by the Avro deserializer and returns a
 * formatted string representation of the event. The formatted string includes the result, duration, number of bytes,
 * operation counter, and event start time.
 */
public final class DeserializerEventFormatter implements Function<RecordedEvent, String> {

  /**
   * The singleton instance of AvroDeserializerEventFormatter.
   */
  public final static DeserializerEventFormatter INSTANCE = new DeserializerEventFormatter();

  DeserializerEventFormatter() {
  }
