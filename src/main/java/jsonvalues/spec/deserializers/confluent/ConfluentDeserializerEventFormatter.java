...
/**
 * A function that takes the Java Flight Recorder (JFR) events generated by the Confluent Avro deserializer and
 * returns a formatted string representation of the event. The formatted string includes the result, topic, duration,
 * number of bytes, operation counter, and event start time.
 */
public final class ConfluentDeserializerEventFormatter implements Function<RecordedEvent, String> {

  /**
   * The singleton instance of {@code ConfluentDeserializerEventFormatter}.
   */
  public final static ConfluentDeserializerEventFormatter INSTANCE = new ConfluentDeserializerEventFormatter();

  ConfluentDeserializerEventFormatter() {
  }
